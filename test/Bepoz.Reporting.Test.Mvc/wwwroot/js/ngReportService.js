(function () {
    ...
    myModule.service('reportService', function ($http) {
        ...
        this.Criteria = function () {
            ...
            // --------------------------------------------------------------------------------- display fields
            $.each(this.criteriaFields, function (i, f) {
                if (f.isDisplayChecked) {
                    var displayField = { Field: f.field, Caption: f.caption, LookupTable: f.lookupTable, LookupField: f.lookupField, LookupFieldValue: f.lookupFieldValue };
            ...
            // --------------------------------------------------------------------------------- ValueFilter fields
            $.each(this.criteriaFields, function (i, f) {
                if (f.isValueFilter && f.isFilterChecked) {
                    var filter = { Field: f.field, Caption: f.caption, Value: f.filterControlValue, LookupTable: f.lookupTable, LookupField: f.lookupField, LookupFieldValue: f.lookupFieldValue };
            ...
            // --------------------------------------------------------------------------------- rangeFilter fields
            $.each(this.criteriaFields, function (i, f) {
                if (f.isRangeFilter && f.isFilterChecked) {
                    var filter = { Field: f.field, Caption: f.caption, FromValue: f.filterControlFromValue, ToValue: f.filterControlToValue, LookupTable: f.lookupTable, LookupField: f.lookupField, LookupFieldValue: f.lookupFieldValue };
